...
setwd("C:/Users/z3526914/OneDrive - UNSW/Vafaee Lab/Projects/Drug Repositioning/DrugRep_Pipeline/")
...
clusterExport(cl=cl, varlist=c("all.GO.terms", "drugTarget.list", "getNeighbours", "V", "ppi.net.all", "nTerms"))

# result = pblapply(drugTarget.list[15], FUN = getGOTerms)
# result = parLapply(cl, drugTarget.list, fun = getGOTerms)
result = parallel::parLapply(cl, 15, fun = getGOTerms)
saveRDS(result, file = "Data/result.BP.rds")
...
save(pairWiseGOSem.mat, file="pairWiseGOSem_BP.rda")